          ...
          Obx(() {
            return
                Stack(alignment: Alignment.center,
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(() =>    signInController.emailError.value.isEmpty
                                ? const SizedBox()
                                : Text(signInController.emailError.value, style: TextStyle(color: const Color(0xFFA2000F),fontSize: Get.height * 0.02)),),
                            SizedBox(
                              height: Get.height * 0.02,
                            ),
                            ...
                            Obx(() =>    signInController.passwordErrorMessage.value.isEmpty
                                ? const SizedBox()
                                : Text(signInController.passwordErrorMessage.value, style: TextStyle(color: const Color(0xFFA2000F),fontSize: Get.height * 0.02)),),
                            Align(alignment: Alignment.centerRight,child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                TextStyle(textBaseline: TextBaseline.ideographic,color: Colors.white,decoration: TextDecoration.underline),),
                              ),
                            )),
                            SizedBox(
                            ...
                            Center(
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  if(signInController.emailError.isEmpty && signInController.passwordErrorMessage.isEmpty)
                                  {
                                    signInController.signIn(signInController.emailController.text, signInController.passwordController.text);
                                  }
                                },
                                child: Container(
                  ...
                  signInController.loader.value  ? const Center(child: CircularProgressIndicator()): const SizedBox()
                ],);
          })
        ),
      ),
