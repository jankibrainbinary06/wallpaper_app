            ...
            children: [
              ...
              Obx(() => Align(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    alignment: Alignment.center,
                    height:  kIsWeb ? 60:Get.height * 0.09,
                    width: 170,
              ...
              StreamBuilder(
                ...
                builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  dasBoardController.imageListBool.value = List.generate(
                      snapshot.data?.docs.length ?? 0, (index) => false);
                  if (snapshot.hasData) {
                    ...
                    return SizedBox(
                      ...
                      child: GridView.builder(
                        ...
                        SliverGridDelegateWithFixedCrossAxisCount(
                            ...
                            childAspectRatio:   kIsWeb ?1.2:0.99),
                        itemBuilder: (context, index) {
                          return snapshot.data?.docs[index]['image'].isEmpty
                              ? Container(
