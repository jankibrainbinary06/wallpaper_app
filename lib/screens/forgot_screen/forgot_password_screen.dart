...
import 'package:wallpaperapp/screens/forgot_screen/resent_password_screen.dart';
...
class ForgotPasswordOtpScreen extends StatelessWidget {
  ...
  ForgotPasswordScreenController forgotPasswordOtpScreenController = Get.put(ForgotPasswordScreenController());
            ...
            Padding(
              ...
              child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                ...
                SizedBox(
                  ...
                  Center(
                    child: Pinput(
                      controller: forgotPasswordOtpScreenController.otpController,
                      autofocus: true,
                      keyboardType: TextInputType.number,
                      length: 4,
                      showCursor: true,
                      cursor: Container(
                          height: 20, width: 2, color: ColorRes.grey),
                      closeKeyboardWhenCompleted: true,
                      submittedPinTheme: forgotPasswordOtpScreenController.submitPinTheme(),
                      defaultPinTheme: forgotPasswordOtpScreenController.defaultTheme
                          .copyDecorationWith(border: Border.all(color: ColorRes.grey),borderRadius: BorderRadius.circular(5)),
                ...
                SizedBox(
                  ...
                  Center(
                    child: GestureDetector(
                      onTap: () {
                       Get.to(ResentPasswordScreen());
                      },
                      child: const Text("Resend OTP",style:
                      TextStyle(textBaseline: TextBaseline.ideographic,color:  ColorRes.splashButton,decoration: TextDecoration.underline),),
                    ),
                  ),
              ],),
            )
