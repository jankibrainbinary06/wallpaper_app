  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(clipBehavior: Clip.none,
        children: [
          Obx(() => dashBoardController.Screens[dashBoardController.selectedItem.value]),
          Obx(()=>
          dashBoardController.isShowbuttomBar.value == false ?
          Positioned(bottom: Get.height * 0.04,left: Get.width * 0.1,child: bottomNavigationBar(context),
          ) : const SizedBox(),
          ),
          // ),
        ],
